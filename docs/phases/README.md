...
| 2 | Repository Setup + CI/CD + Standards | in_progress | [phase-02-foundation-cicd](./phase-02-foundation-cicd/) |
| 3 | Database + Supabase Schema | pending | [phase-03-database-supabase](./phase-03-database-supabase/) |
| 4 | Scanner SDK + Greenhouse | pending | [phase-04-scanner-sdk-greenhouse](./phase-04-scanner-sdk-greenhouse/) |
