            ...
            <div className="space-y-1.5">
              ...
              <div className="h-3 bg-slate-100 rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${totalDiscovered > 0 ? (shortlisted / totalDiscovered) * 100 : 0}%`,
                  }}
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="h-3 bg-slate-100 rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${totalDiscovered > 0 ? (applied / totalDiscovered) * 100 : 0}%`,
                  }}
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="h-3 bg-slate-100 rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${totalDiscovered > 0 ? (interviewing / totalDiscovered) * 100 : 0}%`,
                  }}
                />
              </div>
            </div>
